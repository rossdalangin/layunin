...
<main id="primary" class="site-main py-6">
	<div class="container">
        ...
        <div class="mt-6 p-5 bg-light rounded-4 text-center animate-up">
            <h2 class="h4 fw-bold text-navy mb-3 faq-cta-title"><?php echo esc_html(get_theme_mod('faq_cta_title', 'Still have questions?')); ?></h2>
            <p class="text-muted mb-4 faq-cta-desc"><?php echo esc_html(get_theme_mod('faq_cta_desc', "Can't find the answer you're looking for? Reach out to our strategy team.")); ?></p>
