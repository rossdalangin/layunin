	...
	<div class="card h-100 shadow-sm border-0 overflow-hidden p-0">
		...
		<div class="card-body p-4 <?php echo ($layout == 'list') ? 'd-md-flex align-items-center gap-4' : ''; ?>">
			...
			<div class="d-flex align-items-center justify-content-between mt-auto pt-3 border-top">
				...
				<a href="<?php the_permalink(); ?>" class="text-navy fw-bold small text-decoration-none read-more-text"><?php echo esc_html(get_theme_mod('read_more_text', 'Read More')); ?> <i class="fas fa-arrow-right ms-1"></i></a>
			</div>
			</div>
		</div>
	</div>
