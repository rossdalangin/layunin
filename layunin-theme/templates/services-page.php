...
<main id="primary" class="site-main py-phi">
	<div class="container">
		<header class="entry-header text-center mb-6 animate-up">
			<span class="text-accent text-uppercase fw-bold letter-spacing-2 mb-3 d-block services-badge"><?php echo esc_html(get_theme_mod('services_badge', 'Strategic Implementation')); ?></span>
