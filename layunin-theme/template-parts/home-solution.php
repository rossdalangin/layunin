		...
		<div class="row align-items-center">
			...
			<div class="col-md-6 animate-up" style="animation-delay: 0.2s;">
				...
				<ul class="solution-list">
					...
					<li><strong>Systems:</strong> Proven frameworks for productivity and growth.</li>
					<li><strong>Tools:</strong> Digital resources and AI-powered assets.</li>
					<li><strong>Accountability:</strong> Guidance to keep you moving forward.</li>
				</ul>
				<a href="#" class="btn btn-primary mt-4">Learn More About Our Method</a>
			</div>
		</div>
	</div>
</section>
