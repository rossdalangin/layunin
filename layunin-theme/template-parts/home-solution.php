<?php if ( get_theme_mod( 'show_home_solution', true ) ) : ?>
		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-6">
				<div class="solution-content ps-lg-4">
					...
					<h2 class="display-5 fw-bold text-navy mb-4 solution-title"><?php echo esc_html( get_theme_mod( 'solution_title', 'How Layunin Transforms Your Life' ) ); ?></h2>
					<p class="lead text-muted mb-5 solution-desc"><?php echo esc_html( get_theme_mod( 'solution_desc', 'We provide the roadmap and the tools you need to bridge the gap between where you are and where you want to be.' ) ); ?></p>
