		...
		<div class="row">
			<div class="col-lg-8 animate-up">
				...
				<div class="hero-ctas d-flex gap-3 mt-4">
					<a href="#" class="btn btn-gold btn-lg shadow"><?php echo esc_html( get_theme_mod( 'hero_cta_1_text', 'Download Free Guide' ) ); ?></a>
					<a href="#" class="btn btn-outline-light btn-lg border-2"><?php echo esc_html( get_theme_mod( 'hero_cta_2_text', 'Start Your Journey' ) ); ?></a>
				</div>
			</div>
		</div>
	</div>
