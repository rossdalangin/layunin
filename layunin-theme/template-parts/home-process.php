...
<section class="process-section py-5 bg-white">
	<div class="container py-5 text-center">
		...
		<h2 class="display-4 mb-5"><?php echo esc_html( get_theme_mod('process_title', 'How Layunin Works') ); ?></h2>
		<div class="row mt-5">
			<?php for($i = 1; $i <= 3; $i++) :
				$title = get_theme_mod("process_step_{$i}_title");
				$desc = get_theme_mod("process_step_{$i}_desc");
				if($title) :
			?>
