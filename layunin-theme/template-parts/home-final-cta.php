<section class="final-cta-section bg-navy text-white text-center py-5 border-top border-white-10">
	<div class="container py-5 animate-up">
		...
		<div class="d-flex flex-column flex-md-row gap-3 justify-content-center">
			<a href="#" class="btn btn-gold btn-lg shadow-lg px-5">Join the Community</a>
			<a href="<?php echo esc_url( home_url( '/free-resources/' ) ); ?>" class="btn btn-outline-light btn-lg px-5">Explore Resources</a>
		</div>
	</div>
</section>
